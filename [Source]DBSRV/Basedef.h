...
#define		MAX_ZONE				6
#define		MAX_SERVER				20      // DB서버 1개에 붙을수 있는 Game서버의 갯수
...
typedef enum _ETNClass
{
	...
	eTNCls_Summon = 11, // 소환 몬스터
	eTNCls_SummonOld = 12,
	eTNCls_Follower = 13, // (전투형)
	eTNCls_Trap = 14, // 합정
	eTNCls_Fellow = 15,
...
{	
	...
	eTNAct_ReturnToSaveZone				= 20120, // 실제로는 범용적인 함수가 아니다.
...
{
	_MSG ;
	short		snSiege ; // 0은 공성전 아님, 1은 공성전 중
	short		snDummy ; // 
...
struct		Msg_YutBet
{
	...
	DWORD	dwDummy;
	WORD	wCount[48];						//	현재 소유할수 있는 최대 인벤토리칸의 수
};
...
//	S_REQUEST S_RESPONSE를 사용하기로 한다.
