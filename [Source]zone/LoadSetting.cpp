...
extern                  g_iWorldID; // ������ 1,2,3, �׼��� 0, ������ �����̹Ƿ� default�� 1�� ����
...
short					g_srgAttackTypeVSArmorTypeChart[eAAC_ArmorTypeCount][eAAC_AttackTypeCount]; // 0, 0�� ������� �ʴ´�. 1���� �����Ѵ�.
...
short                   g_srgTimeSchedule[eTS_MaxSlot] = { 0,0,0, };  // 4�� tic,	900(60��*15(=60�ʸ� 4�ʷ� ������ 15�� slice))
...
void LoadSettingTxl()
{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bAIListGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bActionListGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bActionGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bSpeechContentGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bSpeechCommentGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
		int iCmmID = 0;
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bLevelUpGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bAttackTypeVSArmorTypeGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bCoefficientByClassGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bJudgeCombatGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bConsiderGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
		int irgCard[12] = { 0,0,0, };
		int iLevel = 0;
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bRvRPKConsiderGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bEffectToleranceGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bItemByLevelGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
		int iItemCategory = 0; 
		int irgLvl[21] = { 0,0,0, };
	...
	{
		vectorIDLevel.clear();
		if( g_pkSettingMgr->HT_bItemRateByMonLevelGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
		{
			int iMobLevel = 0;
	...
	{
		vectorIDLevel.clear();
		if( g_pkSettingMgr->HT_bItemRateByMonLevelForTestSrvGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
		{
			int iMobLevel = 0;
			int irgLvl[eItm_MaxLevel] = { 0,0,0, };
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bItemGroupGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bRateByItemCategoryGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bKalaAltarGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
...
//				g_krgKalaAltar[iID].y = iY;
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bRewarderPositionGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bEventListGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bTaskListGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bEventScheduleGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bSetItemGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
	...
	vectorIDLevel.clear();
	if( g_pkSettingMgr->HT_bGameEventGetAllID( &vectorIDLevel ) ) // ��� ���̵� ����
	{
