...
*****************************************************************************************/
void CMD5Checksum::GetMD5(byte* pBuf, unsigned int nLength, char *pOutChar)
{
	//entry invariants
...
*****************************************************************************************/
void CMD5Checksum::Final(char* pOutChar)
{
	//Save number of bits
	BYTE Bits[8];
	...
	for ( int i=0; i < nMD5Size; i++) 
	{
		...
		//strMD5 += Str;
		strcat( pOutChar, szTemp );
	}
	//ASSERT( strlen(pOutChar) == 32 );
	//return strMD5;
}
